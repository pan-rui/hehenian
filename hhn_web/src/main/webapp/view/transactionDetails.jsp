    ...
    <head>
       ...
       <script type="text/javascript">
            ...
            function getTransactiondetails(){
                ...
                ajax({
                    url:"<%=request.getContextPath() %>/queryTradeList.do",
                    type:'post',//非必须.默认get
                    data:stParam.join("&"),
                    dataType:'json',//非必须.默认text
                    async:true,//非必须.默认true
                ...
                if(st!=null) {
                    for (var idx = 0; idx < st.length; idx++) {
                        if (st[idx] != '' && st[idx] != 'undefined') {
                            ...
                            '<td>' + st[idx].trade_id + '</td>' +
                            '<td>' + st[idx].period + '月</td>' +
                            '<td>' + st[idx].rate * 100 + '%</td>' +
                            '<td>￥' + st[idx].trade_amount + '</td>' +
                            '<td>' + new Date(st[idx].trade_time).Format("yyyy-MM-dd hh:mm:ss") + '</td>' +
                            '<td>交易成功</td></tr>';
                        }
                    }
                }else{
        ...
        <div class="user-all transactionDetails">
            <div class="user-center">
                <div style=" width:1170px;height:6px; margin:0px auto; padding-bottom:24px;position: relative;">
                    <img src="../images/detail_logo_bg.jpg" style="height:6px;width:1170px;position: absolute;top: 0;" alt=""/>
                </div>
                <div style=" overflow:hidden">
                    ...
                    <div class="u-right">
                        <div class="user-right">
                            <p style="font-size:20px;color:#666666;line-height:50px">购买记录</p>
